...
This implies that if you perform your deep copy on an object that contains reference (object), both the original and copied object refers to different objects and, if you do any changes to the data the copied object, they are not reflected in the original object.
...
class DeepShallowCopy {
    ...
    void shallowCopyTest() {
        ...
        assertThat(book1.getAuthor().getAuthorName())
                .isEqualTo(book2.getAuthor().getAuthorName());
