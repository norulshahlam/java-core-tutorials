...
/* Java provides two interfaces to sort objects using data members of the class:
 ...
 1) provides a single sorting sequence I.e., we can sort the collection on the basis of a single element such as id or name or price.
 ...
 5) can sort the list elements of a Comparable type by Collections.sort(List) method.
 
 Comparator 

 1) provides multiple sorting sequences I.e., can sort the collection on the basis of multiple elements such as id, name, and price etc.
 ...
 5) can sort the list elements of a Comparator type by Collections.sort(List, Comparator) method.
 ...
 For Comparator, a client needs to provide the Comparator class to use in compare() method.
 
 demo how to use comparable (not comparator) comparing only 1 element to sort from the highest age to lowest
