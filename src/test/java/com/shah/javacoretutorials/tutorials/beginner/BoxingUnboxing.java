...
In this field, we can store primitive data types.
In other words, we can wrap a primitive value into a wrapper class object.
Data structures in the Collection framework, such as ArrayList,
LinkedList and Vector store only objects (reference types) and not primitive types.
...
Unboxing - converting an object into the corresponding primitive datatype
...
class BoxingUnboxing {
    ...
    void test() {
        ...
        String str = "123";
        /*  to convert string to int; wrapper class is needed parse int is a static method,
        so to access it, wrapper class is needed(Integer)
         */
